    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sexRg.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                Toast.makeText(AddPetActivity.this, "你的性别为：" + result[0], Toast.LENGTH_SHORT).show();
        ...
        HttpUtil.sendPost("/pet/uploadPet", requestBody, new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                AddPetActivity.this.runOnUiThread(()->{
                    Toast.makeText(AddPetActivity.this.getApplicationContext(),"宠物上传失败",Toast.LENGTH_SHORT).show();
                });
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if (codeResult.getRstCode()==200){
                    AddPetActivity.this.runOnUiThread(()->{
                        Toast.makeText(AddPetActivity.this.getApplicationContext(),"宠物上传成功",Toast.LENGTH_SHORT).show();
                        finish();
                    });
                }
                if (codeResult.getRstCode()==400){
                    AddPetActivity.this.runOnUiThread(()->{
                        Toast.makeText(AddPetActivity.this.getApplicationContext(),codeResult.getMsg(),Toast.LENGTH_SHORT).show();
                    });
                }
