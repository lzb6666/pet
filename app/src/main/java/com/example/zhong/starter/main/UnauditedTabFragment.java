 ...
 */
public class UnauditedTabFragment extends Fragment {


    private FosterListAdapter adapter;

    public UnauditedTabFragment() {
        // Required empty public constructor
    }

    public static Fragment newInstance() {
        UnauditedTabFragment fragment = new UnauditedTabFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_unaudited_tab, container, false);
