    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.getStringExtra("from").equals("record")){
            ...
            adoptBtn.setOnClickListener(v->{
                Intent intentToModifyPet = new Intent(MyPetDetailActivity.this,ModifyPetActivity.class);
                Bundle bundle = new Bundle();
                bundle.putString("petID",petID);
                intentToModifyPet.putExtras(bundle);
                startActivity(intentToModifyPet);
            });
        }
        getPet(petID);
    }
        ...
        HttpUtil.sendPost("/pet",requestBody, new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                MyPetDetailActivity.this.runOnUiThread(()->{
                    Toast.makeText(MyPetDetailActivity.this, "连接服务器失败", Toast.LENGTH_SHORT).show();
                });
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                runOnUiThread(()->{
                    ...
                    Glide.with(MyPetDetailActivity.this)
                            .load(pet.getImgURL())
