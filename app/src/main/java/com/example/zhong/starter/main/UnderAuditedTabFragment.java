 ...
 */
public class UnderAuditedTabFragment extends Fragment {

    private FosterListAdapter adapter;

    public UnderAuditedTabFragment() {
    ...
    public static Fragment newInstance() {
        UnderAuditedTabFragment fragment = new UnderAuditedTabFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_under_audited_tab, container, false);
        ...
        HttpUtil.sendGet("/nurse/applyRecords?userID="+ LogInfo.getUser(getActivity()).getUserID(), new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                getActivity().runOnUiThread(()->{
                    ...
                    adapter.setType("foster_send_under");
                });
            }
        });
    }
