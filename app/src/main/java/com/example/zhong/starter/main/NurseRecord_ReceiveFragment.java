 ...
 */
public class NurseRecord_ReceiveFragment extends Fragment {

    private FosterListAdapter adapter;
    ProgressDialog dialog;

    public NurseRecord_ReceiveFragment() {
        // Required empty public constructor
    }

    public static Fragment newInstance() {
        return new NurseRecord_ReceiveFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_nurse_record__receive, container, false);
        ...
        HttpUtil.sendGet("/nurse/reRecords?userID="+ LogInfo.getUser(getActivity()).getUserID(),new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                getActivity().runOnUiThread(()->{
                    ...
                    adapter.setType("foster_receive");
                });
            }
        });
    }
